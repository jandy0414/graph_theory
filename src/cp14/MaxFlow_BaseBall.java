...
public class MaxFlow_BaseBall {
    ...
    public MaxFlow_BaseBall(WeightedGraph network, int s, int t){
...
//                }
    ...
    public static void main(String[] args) {
        WeightedGraph g=new WeightedGraph("14_baseBall.txt",true);

        MaxFlow_BaseBall maxFlow=new MaxFlow_BaseBall(g,0,10);
